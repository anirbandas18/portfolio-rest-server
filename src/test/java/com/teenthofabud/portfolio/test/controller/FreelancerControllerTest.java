...
public class FreelancerControllerTest {
	...
	private void init() {
		...
		List<PropertyDescriptor> properties = Arrays.asList(BeanUtils.getPropertyDescriptors(FreelancerTestData.class));
	...
	public void shouldReturnFreelancerStatusAndHttpOKWhenFreelancerDetailsIsPosted( ) throws Exception{
		...
		when(freelancerService.createFreelancer(freelancerModel)).thenReturn(freelancerModel.getId());
