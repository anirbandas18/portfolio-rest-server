...
public class Swagger2Configuration {
	...
	private ApiInfo metaData() {
        ...
        ApiInfo apiInfo = new ApiInfo("Portfolio API", "REST to CRUD operation mapping over HTTP on various portfolio models", "1.0", "Terms of service", contact, "Apache License Version 2.0", "https://www.apache.org/licenses/LICENSE-2.0", vendors);
        return apiInfo;
    }
